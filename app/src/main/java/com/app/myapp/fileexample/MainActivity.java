package com.app.myapp.fileexample;
...
public class MainActivity extends Activity implements OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       // String filefolder=getE
        path= Environment.getExternalStorageDirectory().getAbsolutePath()+"/FileExample/";
    ...
    private static boolean saveFile(Context context, String fileName) {
        ...
        try {
            ...
            p.print(" No.\t	 FPID\t	 Status\t	 DateTime  ");
          /*  if(file.exists())
            {
                p.append("1\t 001433 \t 128 \t 2017/05/07 07:55:18 \t 1 ");
            }
            else {
                p.println(" No.	 FPID	 Status	 DateTime  ");
                p.append("1\t 001433 \t 128 \t 2017/05/07 07:55:18 \t 1 ");
            }*/
            Log.w("FileUtils", "Writing " +
                    "file" + file);
            success = true;
        } catch (IOException e) {
